...
public class SofaRestServiceTest extends AbstractTestBase {
    ...
    public void testSofaRestGet(){
        ...
        // TODO 注意：这里只是测试使用，使用的是 jackson 不支持泛型的反序列化，所以被反序列化为 map，这里是仅供测试使用
        //  使用详情参考文档：http://docs.spring.io/spring-boot/docs/1.4.2.RELEASE/reference/htmlsingle/#boot-features-testing
